...
#import <TentFramework/TERouter.h>
#import <TentFramework/TEHelper.h>
#import <TentFramework/ViewUtils.h>
#import <TentFramework/TEAlertViewController.h>
#import <TentFramework/TEConf.h>
#import <TentFramework/NSString+URL+JSON.h>
#import <TentFramework/TEUrlConnection.h>
#import <TentFramework/NSMutableArray+NSDictionary.h>
#import <TentFramework/TableViewWithBlock.h>
#import <TentFramework/TEScrollView.h>
#import <TentFramework/FrameConst.h>
#import <TentFramework/TEImageView.h>
#import <TentFramework/TELoadingViewController.h>
#import <TentFramework/FloatButton.h>
#import <TentFramework/TableViewCell.h>
#import <TentFramework/UITableView+DelegateBlocks.h>
#import <TentFramework/UserListCell.h>
#import <TentFramework/UITableView+DataSourceBlocks.h>
#import <TentFramework/TEWebView.h>
#import <TentFramework/TENetworkingTools.h>
#import <TentFramework/TERequestResultItem.h>

//! Project version number for TentSDK.
FOUNDATION_EXPORT double TentSDKVersionNumber;

//! Project version string for TentSDK.
FOUNDATION_EXPORT const unsigned char TentSDKVersionString[];

/** Tent delegate */
@protocol TentDelegate <NSObject>
@optional
...
@interface TentSDK : NSObject

@property (nonatomic, assign) id<TentDelegate> TentDelegate;
 ...
 */
-(void)initializeApp:(NSString*)appID withDelegate:(id<TentDelegate>)delegate;

/** Show Tent Login
 *
 */
-(void)doLogin;
/**  Tent Logout and then users can't getinto usercenter and paycenter
 *
 */
-(void)doLogout;
/** Show Tent user center
 *
 */
-(void)userCenter;
