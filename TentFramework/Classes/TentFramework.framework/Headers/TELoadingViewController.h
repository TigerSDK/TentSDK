...
@protocol TELoadingCloseDelegate <NSObject>

-(void)closeLoadingViewController;

@end

@interface TELoadingViewController : UIViewController
{
...
@property (nonatomic,weak)id<TELoadingCloseDelegate>delegate;
...
+(TELoadingViewController *)instance;
@end
