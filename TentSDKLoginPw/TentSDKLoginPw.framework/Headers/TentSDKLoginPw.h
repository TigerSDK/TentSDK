 ...
 *===传参数pw，密码
 */
static NSString *const TentSDKLoginPassWord = @"te://login/passWord";

/**自动登录成功回调---用于内部调用
 *===传参数userInfo，用户信息
 */
static NSString *const TentSDKLoginPassWordRefreshTokenSuccess = @"te://login/passWord/refreshTokenSuccess";

/**自动登录失败回调
 *===传参数errorInfo，用户信息
 */
static NSString *const TentSDKLoginPassWordRefreshTokenFailed = @"te://login/passWord/refreshTokenFailed";

@interface TentSDKLoginPw : NSObject
