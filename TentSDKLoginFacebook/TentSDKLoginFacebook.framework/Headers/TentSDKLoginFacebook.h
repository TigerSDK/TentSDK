//
//  TentSDKLoginFacebook.h
//  TentSDKLoginFacebook
//
...
/**Facebook初始化*/
static NSString *const TentSDKLoginFacebookInit = @"te://login/facebook/init";

/**Facebook的application配置
 *传入对应的参数
 */
static NSString *const TentSDKLoginFacebookApplication = @"te://login/facebook/application";
/**Facebook的logEventValueToSumWithParameters配置
 *@param value 传入值
 *@param parameters 传入值
 */
static NSString *const TentSDKLoginFacebookLogEventValueToSumWithParameters = @"te://login/facebook/logEventValueToSumWithParameters";
/**Facebook的logEvent配置
 *@param Price 传入值
 *@param NumItems 传入值
 *@param Currency 传入值
 ...
 *@param ContentID 传入值
 */
static NSString *const TentSDKLoginFacebookLogEvent = @"te://login/facebook/logEvent";

/**Facebook的didFinishLaunchingWithOptions配置
 *@param application 传入值
 *@param options 传入值
 */
static NSString *const TentSDKLoginFacebookDidFinishLaunchingWithOptions = @"te://login/facebook/didFinishLaunchingWithOptions";

/**Facebook的applicationDidBecomeActive配置*/
static NSString *const TentSDKLoginFacebookApplicationDidBecomeActive = @"te://login/facebook/applicationDidBecomeActive";

/**Facebook自动登录
 *==参数isAppLogin，默认不传，若为App用到，则设置YES，---App中会用到，区分接入方是否为App接入。
 */
static NSString *const TentSDKLoginFacebookForFbAutoLogin = @"te://login/facebook/forFbAutoLogin";

/**Facebook登录*/
static NSString *const TentSDKLoginFacebookLogin = @"te://login/facebook/login";

/**Facebook登出*/
static NSString *const TentSDKLoginFacebookLogout = @"te://login/facebook/logout";
 ...
 *@param title
 */
static NSString *const TentSDKLoginFacebookInviteFriendMessage = @"te://login/facebook/inviteFriendMessage";
 ...
 *@param fbaction
 */
static NSString *const TentSDKLoginFacebookShare = @"te://login/facebook/share";

@interface TentSDKLoginFacebook : NSObject
